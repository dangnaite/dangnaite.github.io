...
jQuery(function ($) {
    ...
    for (var i = DNTDEMOCOUNT; i > 0; i--)
    {
        ...
        '<div class="span3" style="margin-left: 15px;">' +
               '<a href="http://dangnaite.github.io/demo'+i+'/index.html" class="thumbnail">' +
                   '<img  alt="coming" style="width: 260px; height: 180px;" src="img/demo' + i + 'pv.'+(i===41?"gif":"png")+'">' +
               '</a>' +
               '<p style="margin-left: 8px;"><a class="btn" href="http://dangnaite.github.io/demo' + i + '/index.html">View details &raquo;</a></p>' +
           '</div>';
    }
